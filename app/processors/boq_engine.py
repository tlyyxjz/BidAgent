...
_CATEGORY_BENCHMARKS: dict[str, dict[str, Any]] = {
    ...
    "土建工程": {"avg": 500, "unit": "平米", "std": 0.25},
    "市政工程": {"avg": 300, "unit": "平米", "std": 0.30},
    "装修工程": {"avg": 800, "unit": "平米", "std": 0.30},
    "绿化工程": {"avg": 200, "unit": "平米", "std": 0.35},
    "水利工程": {"avg": 1000000, "unit": "项", "std": 0.40},
    "公路工程": {"avg": 5000000, "unit": "公里", "std": 0.35},
    "房建工程": {"avg": 2500, "unit": "平米", "std": 0.25},
    "桥梁工程": {"avg": 8000000, "unit": "座", "std": 0.40},
    "管网工程": {"avg": 500, "unit": "米", "std": 0.30},
    "消防工程": {"avg": 150, "unit": "平米", "std": 0.30},
    "系统集成": {"avg": 200000, "unit": "项", "std": 0.45},
    "运维服务": {"avg": 100000, "unit": "年", "std": 0.35},
}
